-- promotions_setup.sql — Creates the promotions table, indexes, and seeds 10 sample records
...
-- Indexes on status and date range columns to speed up filtered queries
...
-- Seed 10 sample promotions spanning 2025–2026; skips rows that already exist
