package frontend;
    ...
    public class menu_items_contents {
        ...
        //  ARCHIVE MODE TOGGLE
        //
        //  IMPORTANT: set archiveMode and button visibility BEFORE
        //  calling repositionRightButtons(), so it reads the updated
        //  archiveMode flag and computes the correct X position.
        // ══════════════════════════════════════════════════════
        ...
        private HBox buildEditableTextCell(String[] item, int colIndex, double width) {
            ...
            String promptText = (colIndex == 3) ? "e.g. 150" : "";
